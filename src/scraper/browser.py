...
async def start_browser():
    ...
    # Get the debugging port from environment variable, default to 9222
    debug_port = os.environ.get('CHROME_REMOTE_DEBUG_PORT', '9222')
    ...
    try:
        async with async_playwright() as p:
            ...
            logger.info(f"Remote debugging available at http://127.0.0.1:{debug_port}")
